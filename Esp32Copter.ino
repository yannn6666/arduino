...
//volatile變數為一個硬體的暫存器，會被硬體所改變，有時一個變數的質改變了，compiler並不會馬上將他寫入記憶體中
